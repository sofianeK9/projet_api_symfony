...
class __TwigTemplate_80ca7788266c3f7e12ba41582c582e0e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  60 => 6,  56 => 5,  52 => 4,  48 => 3,  44 => 1,);
    }
...
\t\t{{ form_start(form) }}
\t\t{{ form_widget(form) }}
\t\t<button class=\"\">{{ button_label|default('Save') }}</button>
\t\t{{ form_end(form) }}
\t</div>
</div>
